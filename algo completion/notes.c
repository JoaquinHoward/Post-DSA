void merge(int arr[], int left, int mid, int right){
    //identify the size of the left array
    //identify the size of the right array
    //create the left and right arrays
    //assign the elements to the temp arrays
    //merge the elements in the temp arrays to the orig array
}

void merge_sort(int arr, int left, int right){
    //if left is less than right, it means that there are still more than 1 element
        //find the middle index
        //divide the array into the left and right side
        //merge the array
}
